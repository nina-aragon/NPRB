...
replace_line(tc_fortran, 56, '     &  file=\'../outputs/wo_assim/swed_base.gdat\',\n')
...
replace_line(hf_fortran, 64, '     &  file=\'../outputs/wo_assim/rofx_base.gdat\',\n')
replace_line(hf_fortran, 86, '      open (81,file=\'../outputs/wo_assim/tc.gdat\',\n')
replace_line(hf_fortran, 280, '      open (unit=71,file=\'../outputs/wo_assim/disc_base.gdat\',\n')
...
ctlpath = out_path+'disc_base.ctl'
