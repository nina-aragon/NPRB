...
start_years = list(range(2011,2019))
...
for styr in start_years:
    ...
    tc_path = SMpath+'timecoef_hist2/'

    # Path to the flow directions fortran file for editing
    tc_fortran = SMpath+'timecoef_hist2/timecoefs.f'
    ...
    hf_path = SMpath+'hydroflow_hist2/'

    # Path to the flow directions fortran file for editing
    hf_fortran = SMpath+'hydroflow_hist2/hydroflow.f'
