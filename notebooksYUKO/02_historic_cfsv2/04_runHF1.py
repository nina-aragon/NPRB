...
start_years = list(range(2003,2011))
...
for styr in start_years:
    ...
    tc_path = SMpath+'timecoef_hist1/'

    # Path to the flow directions fortran file for editing
    tc_fortran = SMpath+'timecoef_hist1/timecoefs.f'
    ...
    hf_path = SMpath+'hydroflow_hist1/'

    # Path to the flow directions fortran file for editing
    hf_fortran = SMpath+'hydroflow_hist1/hydroflow.f'
