...
start_years = list(range(1996,2008))
...
for styr in start_years:
    ...
    tc_path = SMpath+'timecoef_fut/'

    # Path to the flow directions fortran file for editing
    tc_fortran = SMpath+'timecoef_fut/timecoefs.f'
    ...
    hf_path = SMpath+'hydroflow_fut/'

    # Path to the flow directions fortran file for editing
    hf_fortran = SMpath+'hydroflow_fut/hydroflow.f'
